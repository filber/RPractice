...
add.rule(q.strategy, name = "ruleSignal",label = "RSI.BUY.GOLDEN.CROSS",
         arguments = list(
           sigcol = "RSI.SHORT.GT.RSI.LONG",sigval = TRUE,
...
add.rule(q.strategy, name = "ruleSignal",label = "RSI.SELL.DEATH.CROSS",
         arguments = list(
           sigcol = "RSI.SHORT.LT.RSI.LONG",sigval = TRUE,
           orderqty = PARAM$ORDER.QTY.SELL, ordertype = "market", orderside = "long",osFUN="osMaxPos", pricemethod = "market",portfolio=q.strategy),
         type = "exit")

#规则3:短期RSI大于X1买入
add.rule(q.strategy, name = "ruleSignal",label = "RSI.BUY.GT.X1",
         arguments = list(
           sigcol = "RSI.SHORT.GT.X1",sigval = TRUE,
           orderqty = PARAM$ORDER.QTY.BUY, ordertype = "market",osFUN="osMaxPos",orderside = "long", pricemethod = "market",portfolio=q.strategy),
         type = "enter")

#规则4:短期RSI小于X2卖出
add.rule(q.strategy, name = "ruleSignal",label = "RSI.SELL.LT.X2",
         arguments = list(
           sigcol = "RSI.SHORT.LT.X2",sigval = TRUE,
           orderqty = PARAM$ORDER.QTY.SELL, ordertype = "market", orderside = "long",osFUN="osMaxPos", pricemethod = "market",portfolio=q.strategy),
         type = "exit")
